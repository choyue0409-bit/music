// The signature visual: paper ticket stub with perforation, stamp, barcode.
// Three variants — classic (paper), bold (high-contrast), minimal (line only).

import { FONTS, STRINGS, SHOW_TYPES, parseDate, paperTextureUrl } from './design.js'
import { PaperSheet, Stamp, Barcode, Stars, Chip } from './atoms.jsx'

export function TicketStub({
  show, theme, variant = 'classic', width = 348, lang = 'zh',
...
function ClassicStub({ show, theme, width = 348, lang = 'zh', onClick, showStamp }) {
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ flex: 1, padding: '14px 16px', position: 'relative', minWidth: 0 }}>
          <div
            style={{
          ...
          <div
            style={{
              ...
              color: theme.paperFg, letterSpacing: 0.2,
              textTransform: 'uppercase', marginTop: 2, wordBreak: 'break-word',
            }}
          >
            {show.artist}
          </div>
        ...
        <div style={{ position: 'relative', width: 1, background: 'transparent' }}>
          <div style={{
            ...
            backgroundSize: '1px 6px', opacity: 0.32, width: 1,
          }}/>
          <div style={{
...
function BoldStub({ show, theme, width = 348, lang = 'zh', onClick }) {
  const dateParts = parseDate(show.date)
    ...
    >
      <div style={{
        ...
        <div style={{ position: 'relative', padding: '16px 16px 14px' }}>
          ...
          <div style={{
            display: 'flex', alignItems: 'center', justifyContent: 'space-between',
            marginTop: 16, borderTop: '0.5px dashed rgba(242,235,217,0.4)',
            paddingTop: 10,
          }}>
      ...
      <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', gap: 12 }}>
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{
            ...
            fontWeight: 500, color: theme.paperFg, letterSpacing: -0.3,
          }}>{show.artist}</div>
          <div style={{
        ...
        <div style={{ textAlign: 'right' }}>
          <div style={{
            ...
            color: theme.paperMuted, textTransform: 'uppercase',
          }}>{dateParts.month} {dateParts.year}</div>
          <div style={{
